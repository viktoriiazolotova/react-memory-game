...
2. Implemeting flipping effect with CSS for card on click - still needs to 
...
6. Add title with outlines
7. Add best score with memory for each user
8. Add credits for each card and for confetti
9. Check accessibility by using WAVE
